...
```{r}
processed_path = "../data/processed/sap_flow_master.csv"
harmon_singha_path = "../data/external_data/Harmon.csv"
chosen_path = processed_path

processed_csv_path = "../data/processed/temporal_moments_master.csv"
processed_unfiltered_csv_path = "../data/processed/temporal_moments_master_unfiltered.csv"
harmon_csv_path = "../data/external_data/harmon_temporal_moments_master.csv"
chosen_csv_path = processed_csv_path
chosen_unfiltered_csv_path = processed_unfiltered_csv_path
...
write.csv(filtered_tibble, harmon_csv_path)
write.csv(ongoing_tibble, harmon_csv_path)
